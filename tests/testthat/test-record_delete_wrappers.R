test_that('`bs_delete_post()` works', {
  vcr::local_cassette('r_post_delete_post')
...
test_that('`bs_delete_like()` and `bs_unlike()` work', {
  vcr::local_cassette('r_post_delete_like')
...
test_that('`bs_delete_follow()` and `bs_unfollow()` work', {
  vcr::local_cassette('r_post_delete_follow')
...
test_that('`bs_delete_block()` and `bs_unblock()` work', {
  vcr::local_cassette('r_post_delete_block')
...
test_that('`bs_delete_repost()` works', {
  vcr::local_cassette('r_post_delete_repost')
...
test_that('`bs_delete_list()` works', {
  vcr::local_cassette('r_post_delete_list')
...
test_that('`bs_delete_list_item()` works', {
  vcr::local_cassette('r_post_delete_list_item')
...
test_that('`bs_delete_starter_pack()` works', {
  vcr::local_cassette('r_post_delete_starter_pack')
