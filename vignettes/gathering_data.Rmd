...
This vignette has illustrated how to use `bskyr` to collect a variety of public data from Bluesky Social. By interfacing with the AT Protocol’s structured API through a consistent and tidy R interface, `bskyr` enables researchers and developers to explore user behavior, content trends, and social networks on Bluesky. Future enhancements to the package will track changes to the protocol and support additional data access patterns as the ecosystem evolves.
