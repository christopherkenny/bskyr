...
- message_id:
  ...
  Character, optional. Message ID up to which to mark as read.
...
[chat.bsky.convo.updateRead.json
(2025-05-16)](https://github.com/bluesky-social/atproto/blob/main/lexicons/chat/bsky/convo/updateRead.json)
