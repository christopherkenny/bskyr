...
- value:
  ...
  Character, length 1. Reaction to remove.
...
[chat.bsky.convo.removeReaction.json
(2025-05-16)](https://github.com/bluesky-social/atproto/blob/main/lexicons/chat/bsky/convo/removeReaction.json)
