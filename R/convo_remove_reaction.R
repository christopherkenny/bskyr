...
#' @param value Character, length 1. Reaction to remove.
...
#' [chat.bsky.convo.removeReaction.json (2025-05-16)](https://github.com/bluesky-social/atproto/blob/main/lexicons/chat/bsky/convo/removeReaction.json)
#'
...
bs_remove_reaction <- function(convo_id, message_id, value,
  ...
  req_url <- paste0(session_url, '/xrpc/chat.bsky.convo.removeReaction')
